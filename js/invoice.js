...
function renderInvoice(invoice) {
  ...
  if (invoice.status === 'paid') {
    ...
    actions.innerHTML = `
      <button class="btn btn-outline btn-full" onclick="window.print()">🖨 Print / Save as PDF</button>
    `;
  } else {
    actions.innerHTML = `
      <button class="btn btn-gold btn-full btn-lg" onclick="showPaymentOptions()">
